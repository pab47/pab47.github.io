...
global R r b
global obstacle_R1 obstacle_x1 obstacle_y1 %one obtacle (pink circle)
global obstacle_R2 obstacle_x2 obstacle_y2 %new obtacle
global obstacle_R3 obstacle_x3 obstacle_y3 %new obtacle
global obstacle_R4 obstacle_x4 obstacle_y4 %new obtacle
global obstacle_R5 obstacle_x5 obstacle_y5 %new obtacle
global obstacle_R6 obstacle_x6 obstacle_y6 %new obtacle
global obstaclel_visited
global clock_time
...
patch(obstacle_x3+obstacle_R3*cos(phi),obstacle_y3+obstacle_R3*sin(phi),'b');
patch(obstacle_x4+obstacle_R4*cos(phi),obstacle_y4+obstacle_R4*sin(phi),'g');
patch(obstacle_x5+obstacle_R5*cos(phi),obstacle_y5+obstacle_R5*sin(phi),'w');
patch(obstacle_x6+obstacle_R6*cos(phi),obstacle_y6+obstacle_R6*sin(phi),'y');
...
dist_robot_obstacle1 = norm([obstacle_x1-x obstacle_y1-y]); %distance beteween 2 points
dist_robot_obstacle2 = norm([obstacle_x2-x obstacle_y2-y]); %distance beteween 2 points
dist_robot_obstacle3 = norm([obstacle_x3-x obstacle_y3-y]); %distance beteween 2 points
dist_robot_obstacle4 = norm([obstacle_x4-x obstacle_y4-y]); %distance beteween 2 points
dist_robot_obstacle5 = norm([obstacle_x5-x obstacle_y5-y]); %distance beteween 2 points
dist_robot_obstacle6 = norm([obstacle_x6-x obstacle_y6-y]); %distance beteween 2 points


if ( dist_robot_obstacle1 <= (obstacle_R1+R) && obstaclel_visited==0)
    obstaclel_visited=1;
    level = level+1;
    title(['directon change <left/right>; speed change <up/down> ; score = ',num2str(level)],'Fontsize',14);
end
